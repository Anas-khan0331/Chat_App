...
import { GoldButton, GhostGoldButton, GoldDivider, SectionEyebrow } from './Ornaments'
...
export default function Venue() {
  ...
  return (
    <section id="venue" ref={rootRef} className="relative bg-charcoal py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col items-center text-center mb-14">
          ...
          <p className="venue-reveal font-cormorant text-lg text-ivory/75">
            {EVENT.city} · {EVENT.dateLabel}
          </p>
        </div>

        <div className="venue-reveal relative mb-12 overflow-hidden">
          <img
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="venue-reveal">
            <h3 className="font-cinzel text-sm tracking-[0.32em] uppercase text-gold mb-8">
              The day unfolds
            </h3>
            <ol className="relative border-l border-gold/30 ml-2 space-y-8">
              {EVENT.schedule.map((item) => (
                <li key={item.title} className="pl-8 relative">
                  ...
                  <p className="font-cinzel text-[11px] tracking-[0.28em] uppercase text-gold">
                    {item.time}
                  </p>
                  <h4 className="mt-1 font-cormorant text-2xl text-ivory">
                    {item.title}
                  </h4>
          ...
          <div className="venue-reveal">
            <h3 className="font-cinzel text-sm tracking-[0.32em] uppercase text-gold mb-6">
              Find us
            </h3>
            <div className="overflow-hidden border border-gold/25 bg-ink">
              <iframe
                ...
                src={EVENT.mapsEmbed}
                className="h-[320px] w-full grayscale-[30%] contrast-125"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
              />
              <div className="flex items-center justify-between gap-4 px-5 py-4 border-t border-gold/20">
                <p className="font-cormorant text-ivory/80">
                  {EVENT.venue}
                </p>
                <a
                  href={EVENT.mapsDirections}
